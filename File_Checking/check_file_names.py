...
categories = {
    "Building Control": ["building control", "buildingcontrol","completion certificate"],
    ...
    "M&E Certification": ["m&e", "mechanical & electrical","mechanical and electrical"],
    ...
    "Mechanical Extract Ventilation": ["mechanical extract", "ventilation","mechanical ventilation"],
    ...
    "TV Installation": ["tv", "television","tv reception"],
    "Acoustics": ["acoustic","sound","sound reduction"],
    "NHBC": ["nhbc"],
    "Snagging lists": ["snag"],
